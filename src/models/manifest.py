...
class RunManifest(BaseModelStrict):  # FR-030..FR-034
    ...
    composite_hash: str | None = Field(default=None, description="Hash over artifacts list + config signature")
    ...
    @classmethod
    def from_run_config(cls, run_id: str, config: RunConfig, artifacts: list[ArtifactDescriptor]) -> RunManifest:
