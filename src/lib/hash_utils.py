...
def canonical_dumps(obj: Any) -> str:
    ...
    """
    return json.dumps(obj, sort_keys=True, separators=CANONICAL_SEPARATORS, ensure_ascii=False)
...
def run_hash(config_hash: str, dataset_hash: str, float_precision: int, feature_registry_version: str) -> str:
    return combined_hash([config_hash, dataset_hash, str(float_precision), feature_registry_version])
