...
class FeatureRegistry(BaseModel):
    ...
    def model_post_init(self, __context: dict[str, object]) -> None:  # pydantic v2 model hook
...
def build_registry(specs: Sequence[FeatureSpec] | Iterable[FeatureSpec], *, global_shift: int = 1) -> FeatureRegistry:
