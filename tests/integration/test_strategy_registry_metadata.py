...
def test_strategy_registry_metadata() -> None:  # T017
    ...
    reg.register("dual_sma", {"description": "Dual moving average crossover", "version": "1.0"})
    ...
    reg.register("dual_sma", {"version": "1.1", "description": "Dual moving average crossover", "category": "momentum"})
