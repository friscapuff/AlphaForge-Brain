...
def test_metrics_include_anomalies_flag(monkeypatch: MonkeyPatch) -> None:  # monkeypatch fixture from pytest
    ...
    class DummyMeta:
        ...
        anomaly_counters: ClassVar[dict[str, int]] = {"duplicates_dropped": 1, "unexpected_gaps": 0}
